            ...
            <Container size='xl'>
                <Group justify='space-between' style={{ width: '100%' }}>
                    <Group spacing='lg'>
                        ...
                        <Anchor
                            href='https://www.rallit.com/my/log'
                            c='gray.7'
                            fw={500}
                            style={{ display: 'flex', alignItems: 'center', gap: 6 }}
                            underline='never'
                    ...
                    <Group spacing='lg'>
                        <Anchor href='https://www.inflearn.com/inflearn' c='gray.7' fw={500} underline='never'>
                            Our story
                        </Anchor>
                        <Divider orientation='vertical' />
                        <Anchor href='https://www.inflearn.com/intro-group' c='gray.7' fw={500} underline='never'>
                            기업서비스
                        </Anchor>
                        <Divider orientation='vertical' />
                        <Anchor href='https://www.inflearn.com/open-knowledge' c='gray.7' fw={500} underline='never'>
                            지식공유 참여
                        </Anchor>
                    </Group>
                </Group>
